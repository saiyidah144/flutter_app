...
class SQLiteDbProvider {
  ...
  initDB() async {
    ...
    return await openDatabase(
      ...
      await db.execute(
          "CREATE TABLE Expense (""id INTEGER PRIMARY KEY," "amount REAL," "date DATE," "category TEXT,"") ORDER BY date DESC");
      await db.execute("INSERT INTO Expense ('id', 'amount', 'date', 'category' ,  )values (?, ?, ?, ?)",[1, 1000, '2019-04-01', "Food" ]);
    }
    );
  }
